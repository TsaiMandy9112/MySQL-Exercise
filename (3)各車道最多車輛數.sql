...
INSERT INTO `dataset1` (`MAX(``Lane 1 Flow (Veh/Minute)``)`, `MAX(``Lane 2 Flow (Veh/Minute)``)`, `MAX(``Lane 3 Flow (Veh/Minute)``)`, `MAX(``Lane 4 Flow (Veh/Minute)``)`) VALUES
(34, 35, 37, 26);
